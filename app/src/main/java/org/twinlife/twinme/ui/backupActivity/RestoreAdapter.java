        ...
        if (mRestoreActivity.getRestoreState() == null) {
            ...
            if (mRestoreActivity.isVerifyBackupMode() && mRestoreActivity.isVerifyBackupTerminated() && !mRestoreActivity.getRestoreReport().isRestoreUpToDate()) {
                ...
                if (!mRestoreActivity.getRestoreReport().clickToCall.isStatsUpToDate()) {
                    mUIRestoreItems.add(new UIRestoreItem(UIRestoreItem.UIRestoreItemType.SECTION, mRestoreActivity.getString(R.string.premium_services_activity_click_to_call_title), -1, -1, -1));

                    if (mRestoreActivity.getRestoreReport().clickToCall.added != 0) {
                        mUIRestoreItems.add(new UIRestoreItem(UIRestoreItem.UIRestoreItemType.CONTENT, mRestoreActivity.getString(R.string.backup_activity_content_diff_added), R.drawable.add_external_call, mRestoreActivity.getRestoreReport().clickToCall.added, Design.BLACK_COLOR));
                    }

                    if (mRestoreActivity.getRestoreReport().clickToCall.modified != 0) {
                        mUIRestoreItems.add(new UIRestoreItem(UIRestoreItem.UIRestoreItemType.CONTENT, mRestoreActivity.getString(R.string.backup_activity_content_diff_updated), R.drawable.action_edit, mRestoreActivity.getRestoreReport().clickToCall.modified, Design.BLACK_COLOR));
                    }

                    if (mRestoreActivity.getRestoreReport().clickToCall.deleted != 0) {
                        mUIRestoreItems.add(new UIRestoreItem(UIRestoreItem.UIRestoreItemType.CONTENT, mRestoreActivity.getString(R.string.backup_activity_content_diff_deleted), R.drawable.delete_item, mRestoreActivity.getRestoreReport().clickToCall.deleted, -1));
                        mUIRestoreItems.add(new UIRestoreItem(UIRestoreItem.UIRestoreItemType.INFO, mRestoreActivity.getString(R.string.restore_activity_content_contact_deleted_message), -1, -1, -1));
                    }
                }
