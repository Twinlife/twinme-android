    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewType == INFO) {
            ...
            if (position == POSITION_LOCAL_CLEANUP) {
                ...
                settingSectionViewHolder.onBind(mCleanupActivity.getString(R.string.cleanup_view_local_cleanup), false);
                ...
                settingSectionViewHolder.onBind(mCleanupActivity.getString(R.string.cleanup_view_both_clean), false);
