...
public class InvitationExternalCallActivity extends AbstractInvitationCallReceiverActivity {
    private static final String LOG_TAG = "InvitationExtern...";
    ...
    protected void initViews() {
        ...
        setToolBar(R.id.invitation_external_call_activity_tool_bar, DESIGN_NAVIGATION_BAR_COLOR);
        showToolBar(true);
        showBackButton(true);
        ...
        View backgroundView = findViewById(R.id.invitation_external_call_activity_background);
        backgroundView.setBackgroundColor(Color.BLACK);

        View invitationView = findViewById(R.id.invitation_external_call_activity_invitation_view);
        ...
        RoundedView redRoundedView = findViewById(R.id.invitation_external_call_activity_red_rounded_view);
        ...
        RoundedView yellowRoundedView = findViewById(R.id.invitation_external_call_activity_yellow_rounded_view);
        ...
        RoundedView greenRoundedView = findViewById(R.id.invitation_external_call_activity_green_rounded_view);
        ...
        View nameContainerView = findViewById(R.id.invitation_external_call_activity_name_container_view);
        ...
        mNameView = findViewById(R.id.invitation_external_call_activity_name_view);
        Design.updateTextFont(mNameView, Design.FONT_MEDIUM32);
        mNameView.setTextColor(Color.WHITE);

        mAvatarView = findViewById(R.id.invitation_external_call_activity_avatar_view);
        ...
        TextView messageInviteView = findViewById(R.id.invitation_external_call_activity_message_view);
        Design.updateTextFont(messageInviteView, Design.FONT_REGULAR30);
        messageInviteView.setTextColor(Color.WHITE);

        View qrCodeContainerView = findViewById(R.id.invitation_external_call_activity_qrcode_container_view);
        ...
        mQRCodeView = findViewById(R.id.invitation_external_call_activity_qrcode_view);

        mTwincodeView = findViewById(R.id.invitation_external_call_activity_twincode_view);
        ...
        View resetView = findViewById(R.id.invitation_external_call_activity_reset_clickable_view);
        resetView.setOnClickListener(v -> onGenerateCodeClick());

        RoundedView resetRoundedView = findViewById(R.id.invitation_external_call_activity_reset_rounded_view);
        resetRoundedView.setBorder(1, DESIGN_ACTION_BORDER_COLOR);
        resetRoundedView.setColor(Color.BLACK);

        ImageView resetIconView = findViewById(R.id.invitation_external_call_activity_reset_icon_view);
        resetIconView.setColorFilter(Color.WHITE);

        TextView resetTextView = findViewById(R.id.invitation_external_call_activity_reset_text_view);
        Design.updateTextFont(resetTextView, Design.FONT_MEDIUM28);
        resetTextView.setTextColor(Color.WHITE);

        View saveView = findViewById(R.id.invitation_external_call_activity_save_clickable_view);
        saveView.setOnClickListener(v -> onSaveInGalleryClick());

        RoundedView saveRoundedView = findViewById(R.id.invitation_external_call_activity_save_rounded_view);
        saveRoundedView.setBorder(1, DESIGN_ACTION_BORDER_COLOR);
        saveRoundedView.setColor(Color.BLACK);

        ImageView saveIconView = findViewById(R.id.invitation_external_call_activity_save_icon_view);
        saveIconView.setColorFilter(Color.WHITE);

        TextView saveTextView = findViewById(R.id.invitation_external_call_activity_save_text_view);
        Design.updateTextFont(resetTextView, Design.FONT_MEDIUM28);
        saveTextView.setTextColor(Color.WHITE);

        View shareView = findViewById(R.id.invitation_external_call_activity_social_view);
        ...
        TextView socialViewTitleView = findViewById(R.id.invitation_external_call_activity_social_title_view);
        ...
        TextView shareSubTitleView = findViewById(R.id.invitation_external_call_activity_social_subtitle_view);
        ...
        mSaveClickToCallView = findViewById(R.id.invitation_external_call_activity_save_click_to_call_view);
    }
}
