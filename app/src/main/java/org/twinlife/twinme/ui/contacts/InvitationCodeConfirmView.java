...
public class InvitationCodeConfirmView extends AbstractBottomSheetView {
    ...
    public InvitationCodeConfirmView(Context context) {
        super(context);
    }

    public InvitationCodeConfirmView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void initViews() {
        ...
        mOverlayView = findViewById(R.id.invitation_code_confirm_view_overlay_view);
        mActionView = findViewById(R.id.invitation_code_confirm_view_action_view);
        mSlideMarkView = findViewById(R.id.invitation_code_confirm_view_slide_mark_view);
        mAvatarView = findViewById(R.id.invitation_code_confirm_view_avatar_view);
        mIconView = findViewById(R.id.invitation_code_confirm_view_icon_view);
        mIconImageView = findViewById(R.id.invitation_code_confirm_view_icon_image_view);
        mBulletView = findViewById(R.id.invitation_code_confirm_view_bullet_view);
        mTitleView = findViewById(R.id.invitation_code_confirm_view_title_view);
        mMessageView = findViewById(R.id.invitation_code_confirm_view_message_view);
        mConfirmView = findViewById(R.id.invitation_code_confirm_view_confirm_view);
        mConfirmTextView = findViewById(R.id.invitation_code_confirm_view_confirm_text_view);
        mCancelView = findViewById(R.id.invitation_code_confirm_view_cancel_view);
        mCancelTextView = findViewById(R.id.invitation_code_confirm_view_cancel_text_view);
