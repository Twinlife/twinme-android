...
public class MenuItem {
    ...
    public enum MenuItemAction {
        ...
        NO_ACTION, HELP, ABOUT_TWINME, ACCOUNT, DIAGNOSTICS, PERSONALIZATION, SOUND_SETTINGS, PRIVACY, TRANSFER_CALL, SETTINGS_ADVANCED ,MESSAGE_SETTINGS, PROFILE, SUBSCRIBE
    }
