...
public class VideoItem extends Item {
    ...
    public VideoItem(@NonNull VideoDescriptor videoDescriptor, @Nullable Descriptor replyToDescriptor) {

        super(ItemType.VIDEO, videoDescriptor, replyToDescriptor);
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("VideoItem\n");
