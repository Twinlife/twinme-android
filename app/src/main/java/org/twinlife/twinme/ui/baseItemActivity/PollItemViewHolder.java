...
public class PollItemViewHolder extends ItemViewHolder {
    ...
    private final View mPollItemContainer;
    ...
    PollItemViewHolder(BaseItemActivity baseItemActivity, View view) {
        ...
        super(baseItemActivity, view,
                R.id.base_item_activity_poll_item_container,
                R.id.base_item_activity_poll_item_state_view,
                R.id.base_item_activity_poll_item_state_avatar_view,
                R.id.base_item_activity_poll_item_overlay_view,
                R.id.base_item_activity_poll_item_annotation_view,
                R.id.base_item_activity_poll_item_selected_view,
                R.id.base_item_activity_poll_item_selected_image_view,
                R.id.base_item_activity_poll_item_error_image_view);

        mPollItemContainer = view.findViewById(R.id.base_item_activity_poll_item_view);
        mPollItemContainer.setPadding(FILE_ITEM_WIDTH_PADDING, FILE_ITEM_HEIGHT_PADDING, FILE_ITEM_WIDTH_PADDING, 0);
        mPollItemContainer.setClickable(false);

        mPollItemContainer.setOnLongClickListener(v -> {
        ...
        mPollItemContainer.setBackground(mGradientDrawable);

        mQuestionView = view.findViewById(R.id.base_item_activity_poll_item_question_view);
        Design.updateTextFont(mQuestionView, Design.FONT_REGULAR34);
        mQuestionView.setTextColor(getBaseItemActivity().getCustomAppearance().getMessageTextColor());

        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) mQuestionView.getLayoutParams();
        ...
        mChoicesAdapter = new PollChoiceAdapter(getBaseItemActivity().getCustomAppearance().getMessageTextColor());
        ...
        TextView resultTextView = resultView.findViewById(R.id.base_item_activity_poll_item_results_text_view);
        Design.updateTextFont(resultTextView, Design.FONT_REGULAR30);
        resultTextView.setTextColor(getBaseItemActivity().getCustomAppearance().getMessageTextColor());
        ...
        mDeleteView = view.findViewById(R.id.base_item_activity_poll_item_delete_view);
    }
    ...
    void onBind(Item item) {
        ...
        final PollItem pollItem = (PollItem) item;
    ...
    void startDeletedAnimation() {
        ...
        deleteLayoutParams.width = mPollItemContainer.getWidth();
        deleteLayoutParams.height = mPollItemContainer.getHeight();
