...
public class ConversationNotificationsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewType == SWITCH) {
            ...
            if (!isEnabled) {
                capabilityViewHolder.itemView.setOnClickListener(view -> mNotificationsActivity.showPremiumFeatureAlert(UIPremiumFeature.FeatureType.PRIVACY));
            }
            ...
            selectValueViewHolder.onBind(item.geText(), value, true, Design.WHITE_COLOR);
        }
    }
