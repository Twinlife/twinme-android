...
public class PeerPollItemViewHolder extends PeerItemViewHolder {
    ...
    PeerPollItemViewHolder(BaseItemActivity baseItemActivity, View view) {
        ...
        mQuestionView.setTextColor(getBaseItemActivity().getCustomAppearance().getPeerMessageTextColor());
        ...
        mChoicesAdapter = new PollChoiceAdapter(getBaseItemActivity().getCustomAppearance().getPeerMessageTextColor());

        RecyclerView choicesView = view.findViewById(R.id.base_item_activity_peer_poll_item_choices_view);
        ...
        resultTextView.setTextColor(getBaseItemActivity().getCustomAppearance().getPeerMessageTextColor());
    ...
    void onBind(Item item) {
        ...
        mChoicesAdapter.setChoices(getPollResults(pollDescriptor, peerPollItem.getVotes()), mMaxResult);
