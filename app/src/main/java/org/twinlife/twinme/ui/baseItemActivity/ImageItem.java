...
public class ImageItem extends Item {
    ...
    public ImageItem(@NonNull ImageDescriptor imageDescriptor, @Nullable Descriptor replyToDescriptor) {

        super(ItemType.IMAGE, imageDescriptor, replyToDescriptor);
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("ImageItem\n");
