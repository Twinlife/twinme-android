...
class PeerLinkItemViewHolder extends PeerItemViewHolder {
    ...
    PeerLinkItemViewHolder(BaseItemActivity baseItemActivity, View view) {

        super(baseItemActivity, view,
                R.id.base_item_activity_peer_link_item_layout_container,
                R.id.base_item_activity_peer_link_item_avatar,
                R.id.base_item_activity_peer_link_item_overlay_view,
                R.id.base_item_activity_peer_link_item_annotation_view,
                R.id.base_item_activity_peer_link_item_selected_view,
                R.id.base_item_activity_peer_link_item_selected_image_view);

        mPreviewLinkView = view.findViewById(R.id.base_item_activity_peer_link_item_preview_view);
        ...
        mPreviewLinkView.setOnClickListener(view1 -> {
            ...
            baseItemActivity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(getPeerLinkItem().getUrl().toString())));
        });
        ...
        mTitleLinkView = view.findViewById(R.id.base_item_activity_peer_link_item_link_title_textview);
        ...
        mImageLinkView = view.findViewById(R.id.base_item_activity_peer_link_item_link_image);

        mTextView = view.findViewById(R.id.base_item_activity_peer_link_item_text);
        ...
        mReplyTextView = view.findViewById(R.id.base_item_activity_peer_link_item_reply_text);
        ...
        mReplyView = view.findViewById(R.id.base_item_activity_peer_link_item_reply_view);
        ...
        mReplyImageView = view.findViewById(R.id.base_item_activity_peer_link_item_reply_image_view);
        ...
        mReplyContainerImageView = view.findViewById(R.id.base_item_activity_peer_link_item_reply_container_image_view);
        ...
        mReplyToImageContentView = view.findViewById(R.id.base_item_activity_peer_link_item_reply_image_content_view);
        ...
        mEphemeralView = view.findViewById(R.id.base_item_activity_peer_link_item_ephemeral_view);
    ...
    void onBind(Item item) {
        ...
        if (!(item instanceof PeerLinkItem)) {
            return;
        }
        ...
        final ObjectDescriptor objectDescriptor = peerLinkItem.getObjectDescriptor();
        ...
        mTextView.setTypeface(getMessageFont().typeface);
        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getMessageFont().size);
        mTextView.setText(Utils.formatText(peerLinkItem.getContent(), 0));
        ...
        if (replyToDescriptor != null) {
            ...
            switch (replyToDescriptor.getType()) {
                ...
                case IMAGE_DESCRIPTOR:
                    ...
                    relativeLayoutParams.addRule(RelativeLayout.BELOW, R.id.base_item_activity_peer_link_item_reply_container_image_view);
            ...
            relativeLayoutParams.addRule(RelativeLayout.BELOW, R.id.base_item_activity_peer_link_item_preview_view);
        }

        if (item.isEphemeralItem()) {
            mEphemeralView.setVisibility(View.VISIBLE);
            startEphemeralAnimation();
            int leftPadding = (int) (MESSAGE_ITEM_TEXT_WIDTH_PADDING + (DESIGN_EPHEMERAL_HEIGHT * Design.HEIGHT_RATIO));
            mTextView.setPadding(leftPadding, MESSAGE_ITEM_TEXT_DEFAULT_PADDING, MESSAGE_ITEM_TEXT_WIDTH_PADDING, MESSAGE_ITEM_TEXT_DEFAULT_PADDING);
        } else {
    ...
    void onViewRecycled() {
        ...
        mImageLinkView.setImageBitmap(null, null);
    ...
    private PeerLinkItem getPeerLinkItem() {

        return (PeerLinkItem) getItem();
    }
