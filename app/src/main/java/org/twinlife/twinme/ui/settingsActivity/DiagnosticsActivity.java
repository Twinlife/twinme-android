...
public class DiagnosticsActivity extends AbstractTwinmeActivity {
    ...
    private void updateItems() {
        ...
        boolean locationEnable = checkPermissionsWithoutRequest(new Permission[]{Permission.ACCESS_COARSE_LOCATION});
        ...
        mDiagnosticsAdapter.updatePermissions(UIDiagnosticSubsection.DiagnosticSubSectionType.PERMISSION_LOCATION, locationEnable ? UIDiagnosticSubsection.DiagnosticState.OK : UIDiagnosticSubsection.DiagnosticState.KO);
