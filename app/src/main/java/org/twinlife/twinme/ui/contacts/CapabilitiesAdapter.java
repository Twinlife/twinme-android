...
public class CapabilitiesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static int POSITION_SCHEDULE_START = 9;
    private static int POSITION_SCHEDULE_END = 10;

    private static int SECTION_ANSWERING_AUTOMATIC = 11;
    private static int POSITION_ALLOW_ANSWERING_AUTOMATIC = 12;
    private static int POSITION_INFO_ANSWERING_AUTOMATIC = 13;
    ...
    public int getItemCount() {
        ...
        if (mCapabilitiesActivity.scheduleEnable()) {
            if (mCapabilitiesActivity.isGroup()) {
                ...
                POSITION_SCHEDULE_START = 9;
                POSITION_SCHEDULE_END = 10;
                SECTION_ANSWERING_AUTOMATIC = 11;
                POSITION_ALLOW_ANSWERING_AUTOMATIC = 12;
                POSITION_INFO_ANSWERING_AUTOMATIC = 13;
            }
    ...
    public int getItemViewType(int position) {
        ...
        if (position == POSITION_SCHEDULE_START || position == POSITION_SCHEDULE_END) {
            return SCHEDULE;
        } else if (position == SECTION_PERMISSION || position == SECTION_ENABLE_SCHEDULE || position == SECTION_ANSWERING_AUTOMATIC || position == SECTION_CAMERA_CONTROL) {
            return SECTION;
