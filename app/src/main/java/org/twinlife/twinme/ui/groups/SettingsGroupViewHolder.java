...
public class SettingsGroupViewHolder extends RecyclerView.ViewHolder {
    ...
    public SettingsGroupViewHolder(@NonNull View view, SettingsGroupActivity settingsActivity) {
        ...
        mSwitchView = view.findViewById(R.id.settings_group_activity_item_checkbox);
