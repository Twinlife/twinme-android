...
public class AppearanceColorViewHolder extends RecyclerView.ViewHolder {
    ...
    public AppearanceColorViewHolder(@NonNull View view) {
        ...
        mColorNameView = view.findViewById(R.id.space_appearance_activity_appearance_color_item_color_name_view);
        Design.updateTextFont(mColorNameView, Design.FONT_REGULAR32);
        mColorNameView.setTextColor(Design.FONT_COLOR_DEFAULT);

        mColorView = view.findViewById(R.id.space_appearance_activity_appearance_color_item_color_view);
        mColorView.setBorder(Design.BORDER_WIDTH, Design.ITEM_BORDER_COLOR);

        mNoColorImageView = view.findViewById(R.id.space_appearance_activity_appearance_color_item_no_color_content_view);

        mSeparatorView = view.findViewById(R.id.space_appearance_activity_appearance_color_item_separator_view);
