...
public class SplashScreenActivity extends AbstractTwinmeActivity implements SplashService.Observer {
    ...
    private static final int DESIGN_MESSAGE_MARGIN = 60;
    ...
    private void initViews() {
        ...
        setBackgroundColor(Design.SPLASHSCREEN_BACKGROUND_COLOR);
        ...
        marginLayoutParams.topMargin = (int) (Design.HEIGHT_RATIO * DESIGN_MESSAGE_MARGIN);
