...
public class InvitationCodeActivity extends AbstractTwinmeActivity implements InvitationCodeService.Observer {
    ...
    public void onLimitInvitationCodeReach() {
        ...
        mOverlayView.setVisibility(View.GONE);
        mProgressBarView.setVisibility(View.GONE);
        error(getString(R.string.invitation_code_view_limit_message), null);
    }
    ...
    private void showOnboarding(boolean fromInfo) {
        ...
        String message = getString(R.string.invitation_code_view_onboarding_message) + "\n\n" + getString(R.string.invitation_code_view_success_message);
        ...
        if (fromInfo) {
            ...
            defaultConfirmView.setConfirmTitle(getString(R.string.welcome_view_enter));
        }
