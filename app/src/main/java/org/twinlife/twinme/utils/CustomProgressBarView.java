...
public class CustomProgressBarView extends PercentRelativeLayout {
    ...
    private static final int DESIGN_BACKGROUND_COLOR = Design.LIGHT_GREY_BACKGROUND_COLOR;
    private static final int DESIGN_BACKGROUND_DARK_COLOR = Design.GREY_COLOR;
    private static final int DESIGN_PROGRESS_COLOR = Design.getMainStyle();

    public interface Observer {
        void onCustomProgressBarEndAnimation();
    }
    ...
    public void initProgressBar(int width, int height) {
    ...
    private void endAnimation() {
        ...
        if (mObserver != null) {
            mObserver.onCustomProgressBarEndAnimation();
        }
    }
}